 ...
 * 
 */
@WebServiceClient(name = "CidadeSOAPService", targetNamespace = "http://soap.web.digital.agenda.java.academia.everis.com/", wsdlLocation = "http://localhost:8080/agenda-digital-web/soap/ClienteSOAP?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CIDADESOAPSERVICE_QNAME = new QName("http://soap.web.digital.agenda.java.academia.everis.com/", "CidadeSOAPService");
