...
public class ObjectFactory {
    ...
    private final static QName _Update_QNAME = new QName("http://soap.web.digital.agenda.java.academia.everis.com/", "update");
    private final static QName _UpdateResponse_QNAME = new QName("http://soap.web.digital.agenda.java.academia.everis.com/", "updateResponse");
    private final static QName _Delete_QNAME = new QName("http://soap.web.digital.agenda.java.academia.everis.com/", "delete");
    ...
    private final static QName _DeleteResponse_QNAME = new QName("http://soap.web.digital.agenda.java.academia.everis.com/", "deleteResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.web.digital.agenda.java.academia.everis.com/", name = "update")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.web.digital.agenda.java.academia.everis.com/", name = "updateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.web.digital.agenda.java.academia.everis.com/", name = "delete")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.web.digital.agenda.java.academia.everis.com/", name = "deleteResponse")
